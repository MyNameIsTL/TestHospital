...
public class DeviceControllActivity extends Activity implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    private final static String TAG = DeviceControllActivity.class.getSimpleName();
