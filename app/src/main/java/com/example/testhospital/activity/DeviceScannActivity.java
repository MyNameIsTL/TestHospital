 ...
 */
@SuppressLint("NewApi")
public class DeviceScannActivity extends Activity implements OnClickListener, OnItemClickListener {
...
//        	mBluetoothScaner.stopScan(mScanCallback);
    ...
    private class LeDeviceListAdapter extends BaseAdapter {
        ...
        public LeDeviceListAdapter() {
            ...
            mInflator = DeviceScannActivity.this.getLayoutInflater();
        }
...
//	};
    ...
    public void onItemClick(AdapterView<?> adapter, View v, int position, long id) {
        ...
        final Intent intent = new Intent(this, DeviceControllActivity.class);
        intent.putExtra(DeviceControllActivity.EXTRAS_DEVICE_NAME, device.getName());
        intent.putExtra(DeviceControllActivity.EXTRAS_DEVICE_ADDRESS, device.getAddress());
        if (mScanning) {
            if(version_5_plus){
//        	mBluetoothScaner.stopScan(mScanCallback);
            } else {
