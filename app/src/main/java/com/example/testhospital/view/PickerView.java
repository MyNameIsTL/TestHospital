package com.example.testhospital.view;
...
public class PickerView extends View {
    ...
    private int mColorText = 0x333333;//未选中字体颜色
    private int mCurrentSelectedColor = 0x159AFE;//选中字体颜色
    ...
    public void setmCurrentSelectedColor(int color) {
...
//        mMinTextSize = mMaxTextSize / 2f;
    ...
    private void init() {
        ...
        mCurrentPaint.setColor(mCurrentSelectedColor);
    }
    ...
    private void drawData(Canvas canvas) {
        ...
        mCurrentPaint.setAlpha((int) ((mMaxTextAlpha - mMinTextAlpha) * scale + mMinTextAlpha));
        ...
        canvas.drawText(textData, x, baseline, mCurrentPaint);
        // 绘制上方data
